...
public class DisplayComponent
{
   ...
   * @param color Color
   */
  private DisplayComponent(final Color color)
  {
    panel = new JTextPane();
   ...
   */
  public static DisplayComponent createInstance(final Color color)
  {
    if (!exists)
    {
      exists = true;
   ...
   *          ComplexNumber
   */
  public void addComplexNumber(final ComplexNumber complexNumber)
  {
   ...
   *          String
   */
  public void addText(final String addedText)
  {
    this.text += addedText;
